...
Client.Server = function(port, host){
...
Client.prototype.connect = function(){
  ...
  var self = this
    , server = this.server = Client.Server(this.port, this.host);
  ...
  switch(code){
    ...
    case 200:
      if(this.connecting){
        ...
        if(!this.pending_response) this.pending_response = {cmd: ['init']};
      }
...
Client.prototype.destroy = function(fn){
  this.server.destroy();
  this.server = null;
  this.connecting = true;
  this.connected = false;
